                    ...
                    if line_text.startswith('data: '):
                        try:
                            ...
                            if "context_summary" in data and data["context_summary"]:
                                ...
                                context_placeholder.info("Context generated")
                            ...
                            if "suggested_response" in data and data["suggested_response"]:
                                ...
                                response_placeholder.write(suggested_response)
                            ...
                            if "actions" in data and data["actions"]:
                                ...
                                action_placeholder.write(action_list)
                            
                            # If complete, finalize
                            if data.get("complete", False):
                                progress_placeholder.progress(1.0, text="Complete: 100%")
